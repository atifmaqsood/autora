...
import { ArrowRight, ChevronLeft, ChevronRight, Filter, Play, Quote, Star, UserCheck, Volume2, VolumeX } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={toggleVoice}
        className={`absolute right-4 top-14 z-30 flex items-center gap-1.5 rounded-full border border-white/25 bg-[#0B1F33]/90 px-3 py-1.5 text-[11px] font-black uppercase tracking-wider text-white backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-[#F97316] ${
