  ...
  return (
    <div className="space-y-0 pb-20 bg-[#070b14] text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <Reveal className="bg-[#0b0f19] border border-slate-800 rounded-3xl p-8 sm:p-12 shadow-2xl">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <RevealStagger staggerDelay={60} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#070b14] border border-slate-800 text-xs text-white placeholder-slate-600 px-4 py-3 rounded-xl focus:outline-none focus:border-indigo-500 font-medium"
                  />
                </div>
                ...
                <div className="sm:col-span-2 lg:col-span-3">
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#070b14] border border-slate-800 text-xs text-white placeholder-slate-600 p-4 rounded-xl focus:outline-none focus:border-indigo-500 font-medium"
                  />
                </div>
              </RevealStagger>
              ...
              <RevealButton delay={200}>
                <button
                  type="submit"
                  className="bg-[#5271ff] hover:bg-[#4361ee] text-white font-bold text-xs px-10 py-3.5 rounded-full shadow-lg transition-all flex items-center gap-2"
                >
                  <span>Send</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 relative aspect-[4/3] rounded-3xl overflow-hidden border border-slate-800 bg-[#0b0f19] shadow-2xl">
            <Image
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-[#070b14]/90 border border-slate-700 backdrop-blur-md p-5 rounded-2xl flex items-center gap-3">
          ...
          <div className="lg:col-span-6 space-y-6">
              ...
              {locations.map((loc, idx) => (
                <button
                  ...
                  className={`text-[11px] font-bold py-2.5 px-3 rounded-xl border transition-all text-center truncate ${
                    activeLocation === idx
                      ? "bg-[#5271ff] border-[#5271ff] text-white shadow-lg"
            ...
            <div className="bg-[#0b0f19] border border-slate-800 rounded-3xl p-8 space-y-6 shadow-xl">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <a
                  ...
                  className="border border-indigo-500/80 text-indigo-300 hover:bg-indigo-600 hover:text-white text-xs font-bold px-5 py-2.5 rounded-full transition-all flex items-center gap-2"
                >
