    ...
    <div className="bg-[#0B1F33] pb-20 text-white">
      ...
      <section className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <RevealStagger staggerDelay={80} className="space-y-5">
          {faqs.map((item) => (
            <div key={item.question} className="rounded-3xl border border-slate-800 bg-[#102941] p-7 shadow-xl">
              <div className="flex items-start gap-4">
                <HelpCircle className="mt-1 h-6 w-6 shrink-0 text-[#FDBA74]" />
                <div>
        ...
        <Link href="/contact-us" className="mt-10 inline-flex items-center gap-3 rounded-full bg-[#F97316] px-8 py-4 text-sm font-black text-white">
