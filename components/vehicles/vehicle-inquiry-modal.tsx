      ...
      >
        ...
        {submitted ? (
          ...
          <div className="text-center py-6 sm:py-8 space-y-4 animate-in zoom-in-95 duration-200">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#F97316]/15 border border-[#F97316]/30 text-[#FDBA74] rounded-full flex items-center justify-center mx-auto shadow-lg shadow-[#F97316]/20">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs sm:text-sm text-slate-300 max-w-md mx-auto leading-relaxed">
                ...
                <strong className="text-[#FDBA74] font-mono">{confirmationId}</strong>. An AGTP Group specialist will contact you shortly.
              </p>
            </div>
            ...
            <div className="pt-2">
              <button
                type="button"
                className="w-full max-w-md font-bold bg-[#F97316] hover:bg-[#EA580C] text-white py-3.5 rounded-xl uppercase tracking-wider transition-colors shadow-lg shadow-[#F97316]/25 mx-auto block"
                onClick={handleResetAndClose}
              >
          ...
          <div className="w-full">
            {/* Eyebrow Label */}
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-[#FDBA74]">
              <span className="w-4 h-[2px] bg-[#F97316] inline-block" />
            ...
            <form onSubmit={handleSubmit} className="mt-6 sm:mt-8 space-y-5">
              ...
              <div className="pt-2 flex items-center justify-start sm:justify-center md:justify-start">
                <button
                  type="submit"
                  className="w-full sm:w-48 h-12 rounded-xl bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-sm shadow-lg shadow-[#F97316]/30 active:scale-[0.98] transition-all flex items-center justify-center"
                >
                  Submit
                </button>
              </div>
